...
> ⚠️ **实验架构线**：冲塔怪目前在 HiVT 上做实验。HiVT 是裸架构（无辅助任务），
> 是所有辅助学习目标方法的理想基线。详见 [papers/2022-hivt.md](papers/2022-hivt.md)
...
> [!NOTE]
> **基线架构线** — HiVT 作为实验平台，不属于辅助任务论文，但所有辅助方法均可在其上叠加验证。

| 架构 | 会议 | 用途 | 卡片 | 备注 |
|---|---|---|---|---|
| HiVT | CVPR 2022 | 实验基线 | ✅ [卡片](papers/2022-hivt.md) | 冲塔怪当前在用 |
| ADAPT | ICCV 2023 | 同类对比 | ✅ [卡片](papers/2023-adapt.md) | 改进版，非辅助任务 |
| PFR-HiVT | MDPI Sym 2025 | 同类对比 | ✅ [卡片](papers/2025-pfr-hivt.md) | 改交互模块 |
