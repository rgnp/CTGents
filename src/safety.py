...
TOOL_SAFETY: dict[str, SafetyLevel] = {
    ...
    "evolve_query":        SafetyLevel.SAFE,
    "evolve_check_access": SafetyLevel.SAFE,
    "evolve_coverage":     SafetyLevel.SAFE,
    "evolve_suggest_tests": SafetyLevel.SAFE,
    "evolve_status":       SafetyLevel.SAFE,
    "evolve_validate":     SafetyLevel.RISKY,
    "search_papers":       SafetyLevel.SAFE,
    "read_paper":          SafetyLevel.SAFE,
    "save_note":           SafetyLevel.SAFE,
    "search_notes":        SafetyLevel.SAFE,
    "list_notes":          SafetyLevel.SAFE,
    "rag_browse":          SafetyLevel.SAFE,
    "rag_read":            SafetyLevel.SAFE,
